...
<div class="container">
   <div class="col-md-12 align-c pull-down-62 hs_portfolio portfolio_portfolio_short_item"> 
    ...
    <ul class="push-down-62 portfolio-filter" data-scrollreveal="enter from the bottom over 1s but wait 0.5s" style="margin : 5px;">
      <li><a href="1" class="filter-item active" data-filter="all" style="margin:30px; font-size:40px;font-family: 'Poiret One', cursive;" >GAMEZVILLE</a></li>
  ...
  <div class="row push-down-62 portfolio-grid portfolio_portfolio_item" id="grid">
	...
	<img src="images/events/600/gamezville/1_counter_strike.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column" >
        <h2 style="font-family: 'Poiret One', cursive;">COUNTER-STRIKE</h2>	
        <p>Bring along your best sharpshooters, plan out strategies and prepare to kill or be killed as this tournament is going to be a scorching rampage.</br>
	...
	<img src="images/events/600/gamezville/2_car_race.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column">
        <h2 style="font-family: 'Poiret One', cursive;">NEED FOR SPEED</h2>
        <p>If you consider yourself to be the master in this game, it’s time that you try to prove it. </br>
