...
<div class="container">
   <div class="col-md-12 align-c pull-down-62 hs_portfolio portfolio_portfolio_short_item"> 
    ...
    <ul class="push-down-62 portfolio-filter" data-scrollreveal="enter from the bottom over 1s but wait 0.5s" style="margin : 5px;">
      <li><a href="#" class="filter-item active" data-filter="all" style="margin:30px; font-size:40px; font-family: 'Poiret One', cursive;" >QUIZZOTICA</a></li>
  ...
  <div class="row push-down-62 portfolio-grid portfolio_portfolio_item" id="grid">
    <div class="col-md-4 col-md-4 portfolio-item photography mix">
	<img src="images/events/600/quizoticca/1_everything_under_the_sun.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column" >
        <h2 style="font-family: 'Poiret One', cursive;">EVERYTHING UNDER THE SUN</h2>	
        <!--<p>Have a raging addiction for increasing your 'General Knowledge' and testing your limits for the same..?</br>
		   The event comprises of two rounds</br>
            1)Prelims-Written test. 2)Finals-Questionnaire </br>
            <h4> Participants : 1</h4></p>-->
        
		
      </div>
    </div>
     
    <div class="col-md-4 col-md-4  portfolio-item video mix">
    <img src="images/events/600/quizoticca/2_number_ninjas.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.6s">
      <div class="portfolio-details portfolio-details_2_column">
        <h2 style="font-family: 'Poiret One', cursive;">NUMBER NINJAS</h2>
       <!-- <p> Mathematics is not just solving for x, it's also figuring out (wh) y!  Encarta offers you a platform to tease your gray cells, put them to some extensive calculations and voila..

Don't bring along formulae just your wittiness..

</br>         </p>
         <p><h4> Participants : 1</h4   ></p>-->
      </div>
    </div>
    <!-- /.col-md-4 portfolio-item mix -->
    <div class="col-md-4 col-md-4  portfolio-item video mix">
	<img src="images/events/600/quizoticca/3_labyrinth.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column">
        <h2 style="font-family: 'Poiret One', cursive;">LABYRINTH</h2>
<!--        <p>A clarion call to the budding technocrats!!!</br>
		The event is divided into two rounds :</br> 
            1) Prelims - Written test</br>
            2) Finals –Logo quiz + Questionnaire</br>
		</p>
        <p><h4> Participants : 1</h4></p>-->
      </div>
    </div>
  ...
  <div class="container hs_footer_content">
    <div class="hs_footer_copyright index_footer_copyright">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-4 col-md-4 hs_footer_copyright_div">
