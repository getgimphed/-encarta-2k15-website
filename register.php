...
if(!loggedin())
{
  ...
  !empty($_POST['college'])
    ...
    $query="SELECT email FROM reglogin WHERE email='$email'";
    $query_run=mysql_query($query);
    if(mysql_num_rows($query_run)==1){
      echo "<script>window.alert('Email " . $email . " already exists');window.location = 'register.php';</script>";
    }
    else{
        $query="INSERT INTO reglogin (name, branch, year, mobile, email, password, college, city) VALUES" . " ('$name','$branch','$year','$mobile','$email','$password_hash','$college','$city')";
        if($query_run=mysql_query($query)){
          ...
          $to      =  $email;
          $subject =  $name . " , Your Encarta Registeration Successful";
          $message =  $name . " , Congrats For Registerting on Encarta 2k15's Site. The Login details you will be using for login are email : " . $email . " , Password : " . $password . " Your SID is : " . strtoupper($sid) . " ! ";
          $headers = 'From: encarta@encartambm.in' . "\r\n" .
              'Reply-To: encarta@encartambm.in' . "\r\n" .
              'X-Mailer: PHP/' . phpversion();

          mail($to, $subject, $message, $headers);

          echo "<script>window.alert('Check  " . $email . " for email verification.');window.location = 'register.php';</script>";
        }
        else{
          echo "<script>window.alert('We CANNOT Register You Currently. If You SEE THIS MESSAGE, PLEASE CALL ON : +91.8559930375. ');window.location = 'register.php';</script>";
        }
      }
    }
...
// Login WORK 
    if(isset($_POST['loginemail']) && isset($_POST['loginpassword'])){
      ...
      $query="SELECT `userid` FROM `reglogin` WHERE `email`='".mysql_real_escape_string($email)."' AND `password`='".mysql_real_escape_string($password)."'";
      if($query_run=mysql_query($query))
        $query_num_rows=mysql_num_rows($query_run);
        if($query_num_rows==0){
         echo "<script>window.alert('Invalid UserName and Password');window.location = 'register.php';</script>";
        }
...
<br><br><br>
  <div class="hs_heading" id="contact_weare_heading">
    <h2 style="font-family: 'Poiret One', cursive;">Register Now</h2>
    <span>Be a part of Awesomeness</span>
    <div class="hs_pager">
      <ul>
        ...
        <div class="hs_contact_form">
          <form class="form-horizontal" role="form" action="register.php" method="POST">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input id="uname" name="name" type="text" class="form-control" required/>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input id="retypepassword" name="retypepassword" type="password" class="form-control" minlength=8 onfocusout="pass_check()" required/>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-4 control-label">Branch:</label>
              <div class="col-sm-8">
              <select name="branch" style="background-color:#636363;" class="col-md-12" class="form-control" required>
                  <option value="">Select Branch</option>
                  <option value="cse">Computer Science</option>
                  <option value="ecc">Electronics & Computer</option>
                  <option value="eee">Electronics & Electrical</option>
                  <option value="civ">Civil</option>
                  <option value="ite">Information Technology</option>
                  <option value="mec">Mechanical</option>
                  <option value="ece">Electronics & Communication</option>
                  <option value="bct">Building & Construction</option>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
              <select name="year" style="background-color:#636363;" class="col-md-12" class="form-control" required>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input name="mobile" id="mobile" type="text" onblur="return IsMobileNumber('mobile')" class="form-control" required maxlength="10"  size="10" />
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-10">
                <button class="col-md-offset-5 col-sm-offset-6" type="submit" onclick=" return pass_check()">Register Me</button>
        <p id="err"></p>
              </div>
            </div>
          </form>
        ...
        <div class="hs_contact_form">
          <form class="form-horizontal" role="form" action="register.php" method="POST">
            <div class="form-group">
              <label class="col-sm-4 control-label">Email   :</label>
              <div class="col-sm-8">
                <input id="" type="email" name="loginemail" class="form-control" required/>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-4 control-label">Password    :</label>
              <div class="col-sm-8">
                <input id="" type="password" name="loginpassword" class="form-control" required/>
              </div>
            </div>
            
            <div class="form-group">
              <div class="col-sm-10">
                <button class="col-md-offset-6 col-sm-offset-6 " type="submit">Login</button>
        <p id="err"></p>
              </div>
            </div>
          </form>
