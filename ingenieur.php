...
<div class="container">
   <div class="col-md-12 align-c pull-down-62 hs_portfolio portfolio_portfolio_short_item"> 
    ...
    <ul class="push-down-62 portfolio-filter" data-scrollreveal="enter from the bottom over 1s but wait 0.5s" style="margin : 5px;">
      <li><a href="#" class="filter-item active" data-filter="all" style="margin:30px; font-size:40px; font-family: 'Poiret One', cursive;" >Ingenieur</a></li>
 ...
 <!--    <div class="col-md-6 col-sm-6 portfolio-item photography mix">
	<img src="images/events/600/ingenieur/22.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column" >
        <h2 style="font-family: 'Poiret One', cursive;">BLUE PRINT</h2>	
        <p>The competition will be organized in two segments each separately for the civil and mechanical students, testing their skills in their specialized domain.</br>
Duration- 1hour. 
	...
	<img src="images/events/600/ingenieur/26.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column">
        <h2 style="font-family: 'Poiret One', cursive;">CIRCUIT CIPHER</h2>
        <p>Is designing circuits your forte? </br>
		The participant with the perfect circuit after the one hour duration will emerge as the victor.</br> 
Duration- 1 hour
		</p>
        <p><h3> Participants : 1</h3></p>
      </div>
 ...
 -->    <!-- /.col-md-4 portfolio-item mix -->
    <div class="col-md-6 col-sm-6  portfolio-item video mix">
	<img src="images/events/600/ingenieur/1_junkyard_giants.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column">
        <h2 style="font-family: 'Poiret One', cursive;">JUNKYARD GIANTS</h2>
<!--        <h4>Let your charismatic mind over smart your counterparts. </br>
With scraps of junk at your disposal churn out a Rock Garden.</br>
Racing against time, a collaboration to work, set your hands to carve out an artefact of technology. </br>
