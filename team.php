...
<link rel="stylesheet" id="theme-color" type="text/css" href="1"/>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12"> 
          <!-- logo start-->
          <div class="col-lg-2 col-md-2 col-sm-2"> <a href="index.php">
...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <div class="hs_heading" id="team_creative_team_heading">
        <h2 style="font-family: 'Poiret One', cursive;font-family: 'Poiret One', cursive;">creative team</h2>
        <span>Fuel for Innovation</span>
        <div class="hs_pager">
          <ul>
      ...
      <div class="hs_our_team" id="team_our_team">
        <ul>
          <li> <img src="images/team/team1.jpg" alt=""/>
            <div class="hs_team_overlay">
              <h4 style="font-family: 'Poiret One', cursive;">Web & Logo Desginer</h4>
              <h3>Rachit Agarwal</h3>
            </div>
            <div class="hs_team_follow">
              <p>Follow me</p>
              <ul>
                <li><a href="https://www.facebook.com/rachitmbm"><img src="images/icon/facebook.png" alt=""/></a></li>
                <li><a href="javascript:void()"><img src="images/icon/twitter.png" alt=""/></a></li>
                <li><a href="1"><img src="images/icon/googleplus.png" alt=""/></a></li>
              </ul>
            </div>
          </li>
          <li> <img src="images/team/team2.jpg" alt=""/>
            <div class="hs_team_overlay">
              <h4 style="font-family: 'Poiret One', cursive;">Web Desginer &Developer</h4>
              <h3>Vedant Jain</h3>
            </div>
            <div class="hs_team_follow">
              <p>Follow me</p>
              <ul>
                <li><a href="https://www.facebook.com/vedant.jain.14224"><img src="images/icon/facebook.png" alt=""/></a></li>
                <li><a href="https://twitter.com/vedantjain03"><img src="images/icon/twitter.png" alt=""/></a></li>
                <li><a href="https://plus.google.com/u/0/112100615924480533320"><img src="images/icon/googleplus.png" alt=""/></a></li>
              </ul>
            </div>
          </li>
          
          <li> <img src="images/team/team3.jpg" alt=""/>
            <div class="hs_team_overlay">
              <h4 style="font-family: 'Poiret One', cursive;">Web Developer</h4>
              <h3>Mansi Maloo</h3>
            </div>
            <div class="hs_team_follow">
              <p>Follow me</p>
              <ul>
                <li><a href="https://www.facebook.com/mansi.maloo"><img src="images/icon/facebook.png" alt=""/></a></li>
                <li><a href="javascript:void()"><img src="images/icon/twitter.png" alt=""/></a></li>
                <li><a href="https://plus.google.com/u/0/101291722733732394027/"><img src="images/icon/googleplus.png" alt=""/></a></li>
              </ul>
            </div>
          </li>

          <li> <img src="images/team/team4.jpg" alt=""/>
            <div class="hs_team_overlay">
              <h4 style="font-family: 'Poiret One', cursive;">Web Developer</h4>
              <h3>Sanket Gandhi</h3>
            </div>
            <div class="hs_team_follow">
              <p>Follow me</p>
              <ul>
                <li><a href="1"><img src="images/icon/facebook.png" alt=""/></a></li>
                <li><a href="1"><img src="images/icon/twitter.png" alt=""/></a></li>
                <li><a href="1"><img src="images/icon/googleplus.png" alt=""/></a></li>
              </ul>
            </div>
          </li>
   ...
   <div class="hs_margin_bottom_100"></div>
          ...
          <li style="margin-left:165px;"> <img src="images/team/team7.jpg" alt=""/>
            <div class="hs_team_overlay">
              <h4 style="font-family: 'Poiret One', cursive;">Web Developer</h4>
              <h3>Akshara Goyal</h3>
            </div>
            <div class="hs_team_follow">
              <p>Follow me</p>
              <ul>
                <li><a href="https://www.facebook.com/bhavya.nanu"><img src="images/icon/facebook.png" alt=""/></a></li>
                <li><a href="javascript:void()"><img src="images/icon/twitter.png" alt=""/></a></li>
                <li><a href="https://plus.google.com/u/0/106876537266300350266/"><img src="images/icon/googleplus.png" alt=""/></a></li>
              </ul>
            </div>
          </li>
          <li> <img src="images/team/team5.jpg" alt=""/>
            <div class="hs_team_overlay">
              <h4 style="font-family: 'Poiret One', cursive;">Graphic Designer</h4>
              <h3>Bhavya Prashant</h3>
            </div>
            <div class="hs_team_follow">
              <p>Follow me</p>
              <ul>
                <li><a href="https://www.facebook.com/gunjan.deora"><img src="images/icon/facebook.png" alt=""/></a></li>
                <li><a href="javascript:void()"><img src="images/icon/twitter.png" alt=""/></a></li>
                <li><a href="1"><img src="images/icon/googleplus.png" alt=""/></a></li>
              </ul>
            </div>
          </li>
          <li> <img src="images/team/team6.jpg" alt=""/>
            <div class="hs_team_overlay">
              <h4 style="font-family: 'Poiret One', cursive;">Graphic designer</h4>
              <h3>Gunjan Deora</h3>
            </div>
        ...
        <!--   <li> <img src="images/team/team8.jpg" alt=""/>
            <div class="hs_team_overlay">
...
<div class="hs_margin_bottom"></div>
   ...
   <div class="col-lg-12 col-md-12 col-sm-12" id="contact_detail">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
          <p><a href="1"><span><img src="images/flat-icon/contact_phone.png"  alt=""/></span>&nbsp;&nbsp;+91.8559930375 </a></p>
    ...
    <div class="hs_footer_copyright index_footer_copyright">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 hs_footer_copyright_div">
          <p><span>2015</span> C <span>Encarta, MBM</span> All Right Reserved. <span>Developed By: <a href="team.php" style="font-size:1.2em;">Team Encarta </a> </span> </p>          
        </div>
