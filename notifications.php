...
<br><br><br>
  <div class="hs_heading" id="contact_weare_heading">
    <h2 style="font-family: 'Poiret One', cursive;">Notifications</h2>
      ...
      <div class="hs_contact_form_div">
        <div class="hs_contact_form">
            <ul style="font-size:1.2em;">
              <li>The Fest will begin on 20th November 2015 and will celebrate the closing ceremony on 22nd November 2015.</li>
              <li>You need to register first to participate in any of the event. </li>
              <li>The prelims are can be downloaded from <a href="index.php/prelims.php" style="font-size:1.6em; color:white;"> Here </a>.</li>
              <!-- <li>The Result of the prelims is attached in the following file.
              <a href="files/prelims_result.pdf" style="font-size:1.6em; color:white;" download>Result Prelims.</a></li> -->
            </ul>
        </div>
      </div>
    </div>
