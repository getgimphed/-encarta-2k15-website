      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12"> 
          ...
          <div class="col-md-2 col-md-2 col-sm-2">
            <div class="icons"> <a class="facebook" href="https://www.facebook.com/Encarta-2k15-1907469076144784/"></a><a class="googleplus" href="#"></a></div>
          </div>
          <!--social icon end--> 
        </div>
      </div>
...
<div class="container">
   <div class="col-md-12 align-c pull-down-62 hs_portfolio portfolio_portfolio_short_item"> 
    ...
    <ul class="push-down-62 portfolio-filter" data-scrollreveal="enter from the bottom over 1s but wait 0.5s" style="margin : 5px;">
      <li><a href="#" class="filter-item active" data-filter="all" style="margin:30px; font-size:40px;" >GAMEZVILLE</a></li>
  ...
  <div class="row push-down-62 portfolio-grid portfolio_portfolio_item" id="grid">
	...
	<img src="images/portfolio/31.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
	...
	<img src="images/portfolio/32.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column">
