...
<div class="container">
   <div class="col-md-12 align-c pull-down-62 hs_portfolio portfolio_portfolio_short_item"> 
    ...
    <ul class="push-down-62 portfolio-filter" data-scrollreveal="enter from the bottom over 1s but wait 0.5s" style="margin : 5px;">
      <li><a href="#" class="filter-item active" data-filter="all" style="margin:30px; font-size:40px; font-family: 'Poiret One', cursive;" >TECH ART</a></li>
  ...
  <div class="row push-down-62 portfolio-grid portfolio_portfolio_item" id="grid">
	...
	<img src="/images/events/320/tech_art/1_webcrats.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column" >
        <h2 style="font-family: 'Poiret One', cursive;">WEBCRATS</h2>	
<!--
        <p>Designing webpages is an art of the information age.</br> So we invite all the web artisans to test their creative abilities in an all-out competition to be the best front end designer.</br>Duration – 1 hour.
...
-->
	...
	<img src="/images/events/600/tech_art/2_music_mashup.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column">
        <h2 style="font-family: 'Poiret One', cursive;">MUSIC MASHUP</h2>
<!--
        <p>Do you have a way with the beats and the bass?</br>
Prep up for a challenge where you have to battle it out for being the best Virtual DJ. You’d be given 5 songs to prepare your mashup and you’ll have 12 hours to do it. The person who submits the funkiest and the most rocking track will be the winner. </br>
Duration- 12 hour
		</p>
-->
        <p><h3> Participants : 1</h3></p>
