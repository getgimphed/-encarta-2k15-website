...
<div class="container">
   <div class="col-md-12 align-c pull-down-62 hs_portfolio portfolio_portfolio_short_item"> 
    ...
    <ul class="push-down-62 portfolio-filter" data-scrollreveal="enter from the bottom over 1s but wait 0.5s" style="margin : 5px;">
      <li><a href="1" class="filter-item active" data-filter="all" style="margin:30px; font-size:40px; font-family: 'Poiret One', cursive;" >GRAND ARCANUM</a></li>
  ...
  <div class="row push-down-62 portfolio-grid portfolio_portfolio_item" id="grid">
    <div class="col-md-6 col-sm-6 portfolio-item photography mix">
	<img src="images/events/600/grand_arcanum/1_dalaal_street.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column" >
        <h2 style="font-family: 'Poiret One', cursive;">DALAL STREET</h2>	
        <!--<p>Experience the stress and the excitement when you try to make money really, really fast. Each team consists of two participants who are given some virtual money. Grab the maximum sum at the end and emerge as the kings of dalaal street.</br>
		Duration : 2 hours
</p>
    ...
    <div class="col-md-6 col-sm-6  portfolio-item video mix">
	<img src="images/events/600/grand_arcanum/2_mbm_hunt.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column">
        <h2 style="font-family: 'Poiret One', cursive;">EXPLORER'S EYE (MBM HUNT)</h2>
        <!--<p>Solve the clues as they lead on to the next; be in haste as the first team to complete this journey spanning the whole college campus will emerge as the victor.</br>Duration : 2 hour.</p>
		   
    <p><h3> Participants : 5 </h3></p>-->
      </div>
    </div>
    <!-- /.col-md-4 portfolio-item mix -->
    <div class="col-md-6 col-sm-6  portfolio-item graphics  mix"><img src="images/events/600/grand_arcanum/3_pic_a_pic.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column">
        <h2 style="font-family: 'Poiret One', cursive;">PICK A PIC</h2>
        <!--<p> Imagination has no bounds. Test how colorful your imagination is and if you have the IQ when you try to decipher the hidden meaning implicated by a few inter-related images brought along together.</br> Duration : 1 hour.
		</p>
         <p><h3> Participants : 2</h3></p>-->
      </div>
    </div>
