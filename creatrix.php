...
<div class="container">
   <div class="col-md-12 align-c pull-down-62 hs_portfolio portfolio_portfolio_short_item"> 
    ...
    <ul class="push-down-62 portfolio-filter" data-scrollreveal="enter from the bottom over 1s but wait 0.5s" style="margin : 5px;">
      <li><a href="#" class="filter-item active" data-filter="all" style="margin:30px; font-size:40px; font-family: 'Poiret One', cursive;" >Creatrix</a></li>
      <!-- <li><a href="#" class="filter-item" data-filter="photography"><h2>Day1</h2></a></li>
      <li><a href="#" class="filter-item" data-filter="video"><h2>Day 2</h2></a></li>
      <li><a href="#" class="filter-item" data-filter="graphics"><h2>Day 3</h2></a></li>
      	   -->
    </ul>
  ...
  <div class="row push-down-62 portfolio-grid portfolio_portfolio_item" id="grid">
    ...
    <div class="col-md-5 col-sm-5 col-md-offset-1 col-sm-offset-1 portfolio-item mix">
	<img src="images/events/600/creatrix/1_fake_research.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column">
        <h2 style="font-family: 'Poiret One', cursive;">FAKE RESEARCH</h2>
        <!--<p>Try and explore your freaking madness in technical field. The person to make the best sense out of the senseless will be declared as the winner.</br></p>
		   
    <p><h3> Participants : 1 </h3></p>-->
      </div>
    </div>
    <!-- /.col-md-4 portfolio-item mix -->
    <div class="col-md-5 col-sm-5  portfolio-item  mix"><img src="images/events/600/creatrix/2_tech_traversity.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.5s">
      <div class="portfolio-details portfolio-details_2_column">
        <h2 style="font-family: 'Poiret One', cursive;">TECH-TRAVESTY</h2>
    <!--    <p>Now the time has arrived to check your brain retention power !! The more you perceive the tech words and more you retain , more will be your chance to lead !
Those who cross the threshold of first round will get a handsome privilege of learning "What you do is paramount than what you say"..
So try your best guys to enact the correct tech phrase out of the gestures which your teammate endeavor to decipher !!</p>
         <p><h3> Participants : Individual</h3></p>-->
      </div>
    </div>
    <!-- /.col-md-4 portfolio-item mix -->
    <div class="col-md-5 col-sm-5 col-md-offset-1 col-sm-offset-1 portfolio-item mix"><img src="images/events/600/creatrix/3_technorhyme.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.6s">
      <div class="portfolio-details portfolio-details_2_column">
        <h2 style="font-family: 'Poiret One', cursive;">TECHNO-RHYME</h2>
    <!--    <p>.Each participant will be given a technical theme and he/she has to write a poem on the spot using that theme. Your wits and your skill with words will be your only asset in this competition.No of lines - 12 to 20 </br>Duration : 1 hour.
		</p>
         <p><h3> Participants : 1</h3></p>-->
      </div>
    </div>
    <!-- /.col-md-4 portfolio-item mix -->
    <div class="col-md-5 col-sm-5  portfolio-item mix"><img src="images/events/600/creatrix/4_youth_parliament.jpg" alt="" data-scrollreveal="enter from the bottom over 1s but wait 0.6s">
      <div class="portfolio-details portfolio-details_2_column">
        <h2 style="font-family: 'Poiret One', cursive;">YOUTH PARLIAMENT</h2>
        <!--<p>This competition will go on in two rounds.Your orating skills will get you through the first round, where all participants will be required to make a two minute speech on a predetermined topic disclosed at the day of the event only. The second will test the debating skills of the finalists in a fierce group discussion. </p>
          <p><h3> Participants : 1</h3></p> -->
      </div>
    </div>
    <!-- /.col-md-4 portfolio-item mix -->
